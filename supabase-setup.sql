...
INSERT INTO managers (name, email, department) VALUES
  ('Ahmed Hassan', 'ahmed@almanaber.com', 'Engineering'),
  ('Mohamed Ali', 'mohamed@almanaber.com', 'Sales'),
  ('Sara Ibrahim', 'sara@almanaber.com', 'HR'),
  ('Khaled Yousef', 'khaled@almanaber.com', 'Finance'),
  ('Fatma Nabil', 'fatma@almanaber.com', 'Operations'),
  ('Tarek Mansour', 'tarek@almanaber.com', 'IT'),
  ('Rania Adel', 'rania@almanaber.com', 'Marketing'),
  ('Waleed Samir', 'waleed@almanaber.com', 'Quality'),
  ('Noha Ezzat', 'noha@almanaber.com', 'Logistics'),
  ('Hesham Fawzy', 'hesham@almanaber.com', 'Maintenance');

INSERT INTO employees (name, department, manager_id) VALUES
  ('Youssef Tarek', 'Engineering', (SELECT id FROM managers WHERE email = 'ahmed@almanaber.com')),
  ('Nour Adel', 'Engineering', (SELECT id FROM managers WHERE email = 'ahmed@almanaber.com')),
  ('Mina George', 'Engineering', (SELECT id FROM managers WHERE email = 'ahmed@almanaber.com')),
  ('Amira Sayed', 'Sales', (SELECT id FROM managers WHERE email = 'mohamed@almanaber.com')),
  ('Omar Fathy', 'Sales', (SELECT id FROM managers WHERE email = 'mohamed@almanaber.com')),
  ('Salma Khaled', 'Sales', (SELECT id FROM managers WHERE email = 'mohamed@almanaber.com')),
  ('Hana Mostafa', 'HR', (SELECT id FROM managers WHERE email = 'sara@almanaber.com')),
  ('Karim Wael', 'HR', (SELECT id FROM managers WHERE email = 'sara@almanaber.com')),
  ('Layla Ashraf', 'Finance', (SELECT id FROM managers WHERE email = 'khaled@almanaber.com')),
  ('Tamer Hossam', 'Finance', (SELECT id FROM managers WHERE email = 'khaled@almanaber.com')),
  ('Dina Magdy', 'Operations', (SELECT id FROM managers WHERE email = 'fatma@almanaber.com')),
  ('Mahmoud Reda', 'Operations', (SELECT id FROM managers WHERE email = 'fatma@almanaber.com')),
  ('Aya Sherif', 'IT', (SELECT id FROM managers WHERE email = 'tarek@almanaber.com')),
  ('Hassan Nabil', 'IT', (SELECT id FROM managers WHERE email = 'tarek@almanaber.com')),
  ('Farida Sameh', 'Marketing', (SELECT id FROM managers WHERE email = 'rania@almanaber.com')),
  ('Ramy Gamal', 'Quality', (SELECT id FROM managers WHERE email = 'waleed@almanaber.com')),
  ('Nada Emad', 'Logistics', (SELECT id FROM managers WHERE email = 'noha@almanaber.com')),
  ('Hazem Lotfy', 'Maintenance', (SELECT id FROM managers WHERE email = 'hesham@almanaber.com')),
  ('Yasmine Tawfik', 'Engineering', (SELECT id FROM managers WHERE email = 'ahmed@almanaber.com')),
  ('Adel Shokry', 'Operations', (SELECT id FROM managers WHERE email = 'fatma@almanaber.com'));
